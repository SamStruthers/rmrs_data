...
# Testing function
test_precip_df <- download_precip(site_url = clp_data_url$site_url[2],site_number = clp_data_url$site_number[2])
...
```{r}
#Station numbers
clp_Q_site_nums <- c("11531", "11530", "11525", 
                    "11514", "11004", "11515",
                    "11518", "11517", "11516",
                    "6770", "11083", "11082",
                    "11009", "11021")
...
#map function over all sites
clp_q_station_data<- map2_dfr(clp_data_url$site_url, clp_data_url$site_number, download_q)
